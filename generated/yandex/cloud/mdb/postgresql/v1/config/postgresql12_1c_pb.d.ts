...
// file: yandex/cloud/mdb/postgresql/v1/config/postgresql12_1c.proto
...
export class PostgresqlConfig12_1C extends jspb.Message { 
    ...
    setMaxPreparedTransactions(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;

    hasWorkMem(): boolean;
    clearWorkMem(): void;
    getWorkMem(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setWorkMem(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setMaintenanceWorkMem(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setAutovacuumWorkMem(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;

    hasTempFileLimit(): boolean;
    clearTempFileLimit(): void;
    getTempFileLimit(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setTempFileLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;

    hasVacuumCostDelay(): boolean;
    clearVacuumCostDelay(): void;
    getVacuumCostDelay(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setVacuumCostDelay(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setVacuumCostPageHit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setVacuumCostPageMiss(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setVacuumCostPageDirty(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;

    hasVacuumCostLimit(): boolean;
    clearVacuumCostLimit(): void;
    getVacuumCostLimit(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setVacuumCostLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;

    hasBgwriterDelay(): boolean;
    clearBgwriterDelay(): void;
    getBgwriterDelay(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setBgwriterDelay(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setBgwriterLruMaxpages(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setBgwriterLruMultiplier(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig12_1C;
    ...
    setBgwriterFlushAfter(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setBackendFlushAfter(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setOldSnapshotThreshold(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    getWalLevel(): PostgresqlConfig12_1C.WalLevel;
    setWalLevel(value: PostgresqlConfig12_1C.WalLevel): PostgresqlConfig12_1C;
    getSynchronousCommit(): PostgresqlConfig12_1C.SynchronousCommit;
    setSynchronousCommit(value: PostgresqlConfig12_1C.SynchronousCommit): PostgresqlConfig12_1C;
    ...
    setCheckpointTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setCheckpointCompletionTarget(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig12_1C;
    ...
    setCheckpointFlushAfter(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;

    hasMaxWalSize(): boolean;
    clearMaxWalSize(): void;
    getMaxWalSize(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setMaxWalSize(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;

    hasMinWalSize(): boolean;
    clearMinWalSize(): void;
    getMinWalSize(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setMinWalSize(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setMaxStandbyStreamingDelay(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setDefaultStatisticsTarget(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    getConstraintExclusion(): PostgresqlConfig12_1C.ConstraintExclusion;
    setConstraintExclusion(value: PostgresqlConfig12_1C.ConstraintExclusion): PostgresqlConfig12_1C;
    ...
    setCursorTupleFraction(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig12_1C;
    ...
    setFromCollapseLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setJoinCollapseLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    getForceParallelMode(): PostgresqlConfig12_1C.ForceParallelMode;
    setForceParallelMode(value: PostgresqlConfig12_1C.ForceParallelMode): PostgresqlConfig12_1C;
    getClientMinMessages(): PostgresqlConfig12_1C.LogLevel;
    setClientMinMessages(value: PostgresqlConfig12_1C.LogLevel): PostgresqlConfig12_1C;
    getLogMinMessages(): PostgresqlConfig12_1C.LogLevel;
    setLogMinMessages(value: PostgresqlConfig12_1C.LogLevel): PostgresqlConfig12_1C;
    getLogMinErrorStatement(): PostgresqlConfig12_1C.LogLevel;
    setLogMinErrorStatement(value: PostgresqlConfig12_1C.LogLevel): PostgresqlConfig12_1C;
    ...
    setLogMinDurationStatement(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;

    hasLogCheckpoints(): boolean;
    clearLogCheckpoints(): void;
    getLogCheckpoints(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogCheckpoints(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;

    hasLogConnections(): boolean;
    clearLogConnections(): void;
    getLogConnections(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogConnections(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setLogDisconnections(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;

    hasLogDuration(): boolean;
    clearLogDuration(): void;
    getLogDuration(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogDuration(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    getLogErrorVerbosity(): PostgresqlConfig12_1C.LogErrorVerbosity;
    setLogErrorVerbosity(value: PostgresqlConfig12_1C.LogErrorVerbosity): PostgresqlConfig12_1C;

    hasLogLockWaits(): boolean;
    clearLogLockWaits(): void;
    getLogLockWaits(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogLockWaits(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    getLogStatement(): PostgresqlConfig12_1C.LogStatement;
    setLogStatement(value: PostgresqlConfig12_1C.LogStatement): PostgresqlConfig12_1C;

    hasLogTempFiles(): boolean;
    clearLogTempFiles(): void;
    getLogTempFiles(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setLogTempFiles(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    getSearchPath(): string;
    setSearchPath(value: string): PostgresqlConfig12_1C;

    hasRowSecurity(): boolean;
    clearRowSecurity(): void;
    getRowSecurity(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setRowSecurity(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    getDefaultTransactionIsolation(): PostgresqlConfig12_1C.TransactionIsolation;
    setDefaultTransactionIsolation(value: PostgresqlConfig12_1C.TransactionIsolation): PostgresqlConfig12_1C;
    ...
    setStatementTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;

    hasLockTimeout(): boolean;
    clearLockTimeout(): void;
    getLockTimeout(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setLockTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setIdleInTransactionSessionTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    getByteaOutput(): PostgresqlConfig12_1C.ByteaOutput;
    setByteaOutput(value: PostgresqlConfig12_1C.ByteaOutput): PostgresqlConfig12_1C;
    getXmlbinary(): PostgresqlConfig12_1C.XmlBinary;
    setXmlbinary(value: PostgresqlConfig12_1C.XmlBinary): PostgresqlConfig12_1C;
    getXmloption(): PostgresqlConfig12_1C.XmlOption;
    setXmloption(value: PostgresqlConfig12_1C.XmlOption): PostgresqlConfig12_1C;
    ...
    setGinPendingListLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;

    hasDeadlockTimeout(): boolean;
    clearDeadlockTimeout(): void;
    getDeadlockTimeout(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setDeadlockTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setMaxLocksPerTransaction(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setMaxPredLocksPerTransaction(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;

    hasArrayNulls(): boolean;
    clearArrayNulls(): void;
    getArrayNulls(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setArrayNulls(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    getBackslashQuote(): PostgresqlConfig12_1C.BackslashQuote;
    setBackslashQuote(value: PostgresqlConfig12_1C.BackslashQuote): PostgresqlConfig12_1C;

    hasDefaultWithOids(): boolean;
    clearDefaultWithOids(): void;
    getDefaultWithOids(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setDefaultWithOids(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setEscapeStringWarning(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setLoCompatPrivileges(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setOperatorPrecedenceWarning(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setQuoteAllIdentifiers(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setStandardConformingStrings(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setSynchronizeSeqscans(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setTransformNullEquals(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;

    hasExitOnError(): boolean;
    clearExitOnError(): void;
    getExitOnError(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setExitOnError(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;

    hasSeqPageCost(): boolean;
    clearSeqPageCost(): void;
    getSeqPageCost(): google_protobuf_wrappers_pb.DoubleValue | undefined;
    setSeqPageCost(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig12_1C;

    hasRandomPageCost(): boolean;
    clearRandomPageCost(): void;
    getRandomPageCost(): google_protobuf_wrappers_pb.DoubleValue | undefined;
    setRandomPageCost(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig12_1C;
    ...
    setAutovacuumMaxWorkers(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setAutovacuumVacuumCostDelay(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setAutovacuumVacuumCostLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setAutovacuumNaptime(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;

    hasArchiveTimeout(): boolean;
    clearArchiveTimeout(): void;
    getArchiveTimeout(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setArchiveTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setMaxWorkerProcesses(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setMaxParallelWorkers(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setMaxParallelWorkersPerGather(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setAutovacuumVacuumScaleFactor(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig12_1C;
    ...
    setAutovacuumAnalyzeScaleFactor(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig12_1C;
    ...
    setDefaultTransactionReadOnly(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    getTimezone(): string;
    setTimezone(value: string): PostgresqlConfig12_1C;
    ...
    setEnableParallelAppend(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setEnableParallelHash(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setEnablePartitionPruning(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setEnablePartitionwiseAggregate(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setEnablePartitionwiseJoin(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;

    hasJit(): boolean;
    clearJit(): void;
    getJit(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setJit(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setMaxParallelMaintenanceWorkers(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setParallelLeaderParticipation(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setVacuumCleanupIndexScaleFactor(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig12_1C;
    ...
    setLogTransactionSampleRate(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig12_1C;
    getPlanCacheMode(): PostgresqlConfig12_1C.PlanCacheMode;
    setPlanCacheMode(value: PostgresqlConfig12_1C.PlanCacheMode): PostgresqlConfig12_1C;
    ...
    setEffectiveIoConcurrency(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setEffectiveCacheSize(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    clearSharedPreloadLibrariesList(): void;
    getSharedPreloadLibrariesList(): Array<PostgresqlConfig12_1C.SharedPreloadLibraries>;
    setSharedPreloadLibrariesList(value: Array<PostgresqlConfig12_1C.SharedPreloadLibraries>): PostgresqlConfig12_1C;
    addSharedPreloadLibraries(value: PostgresqlConfig12_1C.SharedPreloadLibraries, index?: number): PostgresqlConfig12_1C.SharedPreloadLibraries;
    ...
    setAutoExplainLogMinDuration(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig12_1C;
    ...
    setAutoExplainLogAnalyze(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setAutoExplainLogBuffers(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setAutoExplainLogTiming(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setAutoExplainLogTriggers(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setAutoExplainLogVerbose(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setAutoExplainLogNestedStatements(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setAutoExplainSampleRate(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig12_1C;
    ...
    setPgHintPlanEnableHint(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    ...
    setPgHintPlanEnableHintTable(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig12_1C;
    getPgHintPlanDebugPrint(): PostgresqlConfig12_1C.PgHintPlanDebugPrint;
    setPgHintPlanDebugPrint(value: PostgresqlConfig12_1C.PgHintPlanDebugPrint): PostgresqlConfig12_1C;
    getPgHintPlanMessageLevel(): PostgresqlConfig12_1C.LogLevel;
    setPgHintPlanMessageLevel(value: PostgresqlConfig12_1C.LogLevel): PostgresqlConfig12_1C;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): PostgresqlConfig12_1C.AsObject;
    static toObject(includeInstance: boolean, msg: PostgresqlConfig12_1C): PostgresqlConfig12_1C.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: PostgresqlConfig12_1C, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): PostgresqlConfig12_1C;
    static deserializeBinaryFromReader(message: PostgresqlConfig12_1C, reader: jspb.BinaryReader): PostgresqlConfig12_1C;
}

export namespace PostgresqlConfig12_1C {
    export type AsObject = {
        ...
        walLevel: PostgresqlConfig12_1C.WalLevel,
        synchronousCommit: PostgresqlConfig12_1C.SynchronousCommit,
        ...
        constraintExclusion: PostgresqlConfig12_1C.ConstraintExclusion,
        ...
        forceParallelMode: PostgresqlConfig12_1C.ForceParallelMode,
        clientMinMessages: PostgresqlConfig12_1C.LogLevel,
        logMinMessages: PostgresqlConfig12_1C.LogLevel,
        logMinErrorStatement: PostgresqlConfig12_1C.LogLevel,
        ...
        byteaOutput: PostgresqlConfig12_1C.ByteaOutput,
        xmlbinary: PostgresqlConfig12_1C.XmlBinary,
        xmloption: PostgresqlConfig12_1C.XmlOption,
        ...
        backslashQuote: PostgresqlConfig12_1C.BackslashQuote,
        ...
        planCacheMode: PostgresqlConfig12_1C.PlanCacheMode,
        ...
        sharedPreloadLibrariesList: Array<PostgresqlConfig12_1C.SharedPreloadLibraries>,
        ...
        pgHintPlanDebugPrint: PostgresqlConfig12_1C.PgHintPlanDebugPrint,
        pgHintPlanMessageLevel: PostgresqlConfig12_1C.LogLevel,
    }
...
export class PostgresqlConfigSet12_1C extends jspb.Message { 

    hasEffectiveConfig(): boolean;
    clearEffectiveConfig(): void;
    getEffectiveConfig(): PostgresqlConfig12_1C | undefined;
    setEffectiveConfig(value?: PostgresqlConfig12_1C): PostgresqlConfigSet12_1C;

    hasUserConfig(): boolean;
    clearUserConfig(): void;
    getUserConfig(): PostgresqlConfig12_1C | undefined;
    setUserConfig(value?: PostgresqlConfig12_1C): PostgresqlConfigSet12_1C;

    hasDefaultConfig(): boolean;
    clearDefaultConfig(): void;
    getDefaultConfig(): PostgresqlConfig12_1C | undefined;
    setDefaultConfig(value?: PostgresqlConfig12_1C): PostgresqlConfigSet12_1C;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): PostgresqlConfigSet12_1C.AsObject;
    static toObject(includeInstance: boolean, msg: PostgresqlConfigSet12_1C): PostgresqlConfigSet12_1C.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: PostgresqlConfigSet12_1C, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): PostgresqlConfigSet12_1C;
    static deserializeBinaryFromReader(message: PostgresqlConfigSet12_1C, reader: jspb.BinaryReader): PostgresqlConfigSet12_1C;
}

export namespace PostgresqlConfigSet12_1C {
    export type AsObject = {
        effectiveConfig?: PostgresqlConfig12_1C.AsObject,
        userConfig?: PostgresqlConfig12_1C.AsObject,
        defaultConfig?: PostgresqlConfig12_1C.AsObject,
    }
}
