...
export class ListResourcePresetsResponse extends jspb.Message { 
    ...
    getResourcePresetsList(): Array<yandex_cloud_dataproc_v1_resource_preset_pb.ResourcePreset>;
    setResourcePresetsList(value: Array<yandex_cloud_dataproc_v1_resource_preset_pb.ResourcePreset>): ListResourcePresetsResponse;
    addResourcePresets(value?: yandex_cloud_dataproc_v1_resource_preset_pb.ResourcePreset, index?: number): yandex_cloud_dataproc_v1_resource_preset_pb.ResourcePreset;
...
export namespace ListResourcePresetsResponse {
    export type AsObject = {
        resourcePresetsList: Array<yandex_cloud_dataproc_v1_resource_preset_pb.ResourcePreset.AsObject>,
