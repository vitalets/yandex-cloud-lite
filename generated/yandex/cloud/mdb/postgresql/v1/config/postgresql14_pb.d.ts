...
// file: yandex/cloud/mdb/postgresql/v1/config/postgresql14.proto
...
export class PostgresqlConfig14 extends jspb.Message { 
    ...
    setMaxPreparedTransactions(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasWorkMem(): boolean;
    clearWorkMem(): void;
    getWorkMem(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setWorkMem(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setMaintenanceWorkMem(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setAutovacuumWorkMem(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasTempFileLimit(): boolean;
    clearTempFileLimit(): void;
    getTempFileLimit(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setTempFileLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasVacuumCostDelay(): boolean;
    clearVacuumCostDelay(): void;
    getVacuumCostDelay(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setVacuumCostDelay(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setVacuumCostPageHit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setVacuumCostPageMiss(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setVacuumCostPageDirty(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasVacuumCostLimit(): boolean;
    clearVacuumCostLimit(): void;
    getVacuumCostLimit(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setVacuumCostLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasBgwriterDelay(): boolean;
    clearBgwriterDelay(): void;
    getBgwriterDelay(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setBgwriterDelay(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setBgwriterLruMaxpages(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setBgwriterLruMultiplier(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig14;
    ...
    setBgwriterFlushAfter(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setBackendFlushAfter(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setOldSnapshotThreshold(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    getWalLevel(): PostgresqlConfig14.WalLevel;
    setWalLevel(value: PostgresqlConfig14.WalLevel): PostgresqlConfig14;
    getSynchronousCommit(): PostgresqlConfig14.SynchronousCommit;
    setSynchronousCommit(value: PostgresqlConfig14.SynchronousCommit): PostgresqlConfig14;
    ...
    setCheckpointTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setCheckpointCompletionTarget(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig14;
    ...
    setCheckpointFlushAfter(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasMaxWalSize(): boolean;
    clearMaxWalSize(): void;
    getMaxWalSize(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setMaxWalSize(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasMinWalSize(): boolean;
    clearMinWalSize(): void;
    getMinWalSize(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setMinWalSize(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setMaxStandbyStreamingDelay(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setDefaultStatisticsTarget(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    getConstraintExclusion(): PostgresqlConfig14.ConstraintExclusion;
    setConstraintExclusion(value: PostgresqlConfig14.ConstraintExclusion): PostgresqlConfig14;
    ...
    setCursorTupleFraction(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig14;
    ...
    setFromCollapseLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setJoinCollapseLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    getForceParallelMode(): PostgresqlConfig14.ForceParallelMode;
    setForceParallelMode(value: PostgresqlConfig14.ForceParallelMode): PostgresqlConfig14;
    getClientMinMessages(): PostgresqlConfig14.LogLevel;
    setClientMinMessages(value: PostgresqlConfig14.LogLevel): PostgresqlConfig14;
    getLogMinMessages(): PostgresqlConfig14.LogLevel;
    setLogMinMessages(value: PostgresqlConfig14.LogLevel): PostgresqlConfig14;
    getLogMinErrorStatement(): PostgresqlConfig14.LogLevel;
    setLogMinErrorStatement(value: PostgresqlConfig14.LogLevel): PostgresqlConfig14;
    ...
    setLogMinDurationStatement(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasLogCheckpoints(): boolean;
    clearLogCheckpoints(): void;
    getLogCheckpoints(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogCheckpoints(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;

    hasLogConnections(): boolean;
    clearLogConnections(): void;
    getLogConnections(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogConnections(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setLogDisconnections(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;

    hasLogDuration(): boolean;
    clearLogDuration(): void;
    getLogDuration(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogDuration(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    getLogErrorVerbosity(): PostgresqlConfig14.LogErrorVerbosity;
    setLogErrorVerbosity(value: PostgresqlConfig14.LogErrorVerbosity): PostgresqlConfig14;

    hasLogLockWaits(): boolean;
    clearLogLockWaits(): void;
    getLogLockWaits(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogLockWaits(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    getLogStatement(): PostgresqlConfig14.LogStatement;
    setLogStatement(value: PostgresqlConfig14.LogStatement): PostgresqlConfig14;

    hasLogTempFiles(): boolean;
    clearLogTempFiles(): void;
    getLogTempFiles(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setLogTempFiles(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    getSearchPath(): string;
    setSearchPath(value: string): PostgresqlConfig14;

    hasRowSecurity(): boolean;
    clearRowSecurity(): void;
    getRowSecurity(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setRowSecurity(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    getDefaultTransactionIsolation(): PostgresqlConfig14.TransactionIsolation;
    setDefaultTransactionIsolation(value: PostgresqlConfig14.TransactionIsolation): PostgresqlConfig14;
    ...
    setStatementTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasLockTimeout(): boolean;
    clearLockTimeout(): void;
    getLockTimeout(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setLockTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setIdleInTransactionSessionTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    getByteaOutput(): PostgresqlConfig14.ByteaOutput;
    setByteaOutput(value: PostgresqlConfig14.ByteaOutput): PostgresqlConfig14;
    getXmlbinary(): PostgresqlConfig14.XmlBinary;
    setXmlbinary(value: PostgresqlConfig14.XmlBinary): PostgresqlConfig14;
    getXmloption(): PostgresqlConfig14.XmlOption;
    setXmloption(value: PostgresqlConfig14.XmlOption): PostgresqlConfig14;
    ...
    setGinPendingListLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasDeadlockTimeout(): boolean;
    clearDeadlockTimeout(): void;
    getDeadlockTimeout(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setDeadlockTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setMaxLocksPerTransaction(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setMaxPredLocksPerTransaction(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasArrayNulls(): boolean;
    clearArrayNulls(): void;
    getArrayNulls(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setArrayNulls(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    getBackslashQuote(): PostgresqlConfig14.BackslashQuote;
    setBackslashQuote(value: PostgresqlConfig14.BackslashQuote): PostgresqlConfig14;

    hasDefaultWithOids(): boolean;
    clearDefaultWithOids(): void;
    getDefaultWithOids(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setDefaultWithOids(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setEscapeStringWarning(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setLoCompatPrivileges(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setQuoteAllIdentifiers(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setStandardConformingStrings(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setSynchronizeSeqscans(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setAutovacuumMaxWorkers(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setAutovacuumVacuumCostDelay(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setAutovacuumVacuumCostLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setAutovacuumNaptime(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasArchiveTimeout(): boolean;
    clearArchiveTimeout(): void;
    getArchiveTimeout(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setArchiveTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setMaxWorkerProcesses(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setMaxParallelWorkers(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setMaxParallelWorkersPerGather(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setAutovacuumVacuumScaleFactor(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig14;
    ...
    setAutovacuumAnalyzeScaleFactor(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig14;
    ...
    setDefaultTransactionReadOnly(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    getTimezone(): string;
    setTimezone(value: string): PostgresqlConfig14;
    ...
    setEnableParallelAppend(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setEnableParallelHash(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setEnablePartitionPruning(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setEnablePartitionwiseAggregate(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setEnablePartitionwiseJoin(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;

    hasJit(): boolean;
    clearJit(): void;
    getJit(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setJit(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setMaxParallelMaintenanceWorkers(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setParallelLeaderParticipation(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setLogTransactionSampleRate(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig14;
    getPlanCacheMode(): PostgresqlConfig14.PlanCacheMode;
    setPlanCacheMode(value: PostgresqlConfig14.PlanCacheMode): PostgresqlConfig14;
    ...
    setEffectiveIoConcurrency(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setEffectiveCacheSize(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    clearSharedPreloadLibrariesList(): void;
    getSharedPreloadLibrariesList(): Array<PostgresqlConfig14.SharedPreloadLibraries>;
    setSharedPreloadLibrariesList(value: Array<PostgresqlConfig14.SharedPreloadLibraries>): PostgresqlConfig14;
    addSharedPreloadLibraries(value: PostgresqlConfig14.SharedPreloadLibraries, index?: number): PostgresqlConfig14.SharedPreloadLibraries;
    ...
    setAutoExplainLogMinDuration(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setAutoExplainLogAnalyze(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setAutoExplainLogBuffers(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setAutoExplainLogTiming(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setAutoExplainLogTriggers(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setAutoExplainLogVerbose(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setAutoExplainLogNestedStatements(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setAutoExplainSampleRate(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig14;
    ...
    setPgHintPlanEnableHint(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setPgHintPlanEnableHintTable(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    getPgHintPlanDebugPrint(): PostgresqlConfig14.PgHintPlanDebugPrint;
    setPgHintPlanDebugPrint(value: PostgresqlConfig14.PgHintPlanDebugPrint): PostgresqlConfig14;
    getPgHintPlanMessageLevel(): PostgresqlConfig14.LogLevel;
    setPgHintPlanMessageLevel(value: PostgresqlConfig14.LogLevel): PostgresqlConfig14;
    ...
    setHashMemMultiplier(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig14;
    ...
    setLogicalDecodingWorkMem(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setMaintenanceIoConcurrency(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setMaxSlotWalKeepSize(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasWalKeepSize(): boolean;
    clearWalKeepSize(): void;
    getWalKeepSize(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setWalKeepSize(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setEnableIncrementalSort(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;
    ...
    setAutovacuumVacuumInsertThreshold(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setAutovacuumVacuumInsertScaleFactor(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig14;
    ...
    setLogMinDurationSample(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setLogStatementSampleRate(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlConfig14;
    ...
    setLogParameterMaxLength(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;
    ...
    setLogParameterMaxLengthOnError(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasClientConnectionCheckInterval(): boolean;
    clearClientConnectionCheckInterval(): void;
    getClientConnectionCheckInterval(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setClientConnectionCheckInterval(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasEnableAsyncAppend(): boolean;
    clearEnableAsyncAppend(): void;
    getEnableAsyncAppend(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setEnableAsyncAppend(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;

    hasEnableGathermerge(): boolean;
    clearEnableGathermerge(): void;
    getEnableGathermerge(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setEnableGathermerge(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;

    hasEnableMemoize(): boolean;
    clearEnableMemoize(): void;
    getEnableMemoize(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setEnableMemoize(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;

    hasLogRecoveryConflictWaits(): boolean;
    clearLogRecoveryConflictWaits(): void;
    getLogRecoveryConflictWaits(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogRecoveryConflictWaits(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlConfig14;

    hasVacuumFailsafeAge(): boolean;
    clearVacuumFailsafeAge(): void;
    getVacuumFailsafeAge(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setVacuumFailsafeAge(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    hasVacuumMultixactFailsafeAge(): boolean;
    clearVacuumMultixactFailsafeAge(): void;
    getVacuumMultixactFailsafeAge(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setVacuumMultixactFailsafeAge(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlConfig14;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): PostgresqlConfig14.AsObject;
    static toObject(includeInstance: boolean, msg: PostgresqlConfig14): PostgresqlConfig14.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: PostgresqlConfig14, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): PostgresqlConfig14;
    static deserializeBinaryFromReader(message: PostgresqlConfig14, reader: jspb.BinaryReader): PostgresqlConfig14;
}

export namespace PostgresqlConfig14 {
    export type AsObject = {
        ...
        walLevel: PostgresqlConfig14.WalLevel,
        synchronousCommit: PostgresqlConfig14.SynchronousCommit,
        ...
        constraintExclusion: PostgresqlConfig14.ConstraintExclusion,
        ...
        forceParallelMode: PostgresqlConfig14.ForceParallelMode,
        clientMinMessages: PostgresqlConfig14.LogLevel,
        logMinMessages: PostgresqlConfig14.LogLevel,
        logMinErrorStatement: PostgresqlConfig14.LogLevel,
        ...
        byteaOutput: PostgresqlConfig14.ByteaOutput,
        xmlbinary: PostgresqlConfig14.XmlBinary,
        xmloption: PostgresqlConfig14.XmlOption,
        ...
        backslashQuote: PostgresqlConfig14.BackslashQuote,
        ...
        planCacheMode: PostgresqlConfig14.PlanCacheMode,
        ...
        sharedPreloadLibrariesList: Array<PostgresqlConfig14.SharedPreloadLibraries>,
        ...
        pgHintPlanDebugPrint: PostgresqlConfig14.PgHintPlanDebugPrint,
        pgHintPlanMessageLevel: PostgresqlConfig14.LogLevel,
        ...
        clientConnectionCheckInterval?: google_protobuf_wrappers_pb.Int64Value.AsObject,
        enableAsyncAppend?: google_protobuf_wrappers_pb.BoolValue.AsObject,
        enableGathermerge?: google_protobuf_wrappers_pb.BoolValue.AsObject,
        enableMemoize?: google_protobuf_wrappers_pb.BoolValue.AsObject,
        logRecoveryConflictWaits?: google_protobuf_wrappers_pb.BoolValue.AsObject,
        vacuumFailsafeAge?: google_protobuf_wrappers_pb.Int64Value.AsObject,
        vacuumMultixactFailsafeAge?: google_protobuf_wrappers_pb.Int64Value.AsObject,
    }
...
export class PostgresqlConfigSet14 extends jspb.Message { 

    hasEffectiveConfig(): boolean;
    clearEffectiveConfig(): void;
    getEffectiveConfig(): PostgresqlConfig14 | undefined;
    setEffectiveConfig(value?: PostgresqlConfig14): PostgresqlConfigSet14;

    hasUserConfig(): boolean;
    clearUserConfig(): void;
    getUserConfig(): PostgresqlConfig14 | undefined;
    setUserConfig(value?: PostgresqlConfig14): PostgresqlConfigSet14;

    hasDefaultConfig(): boolean;
    clearDefaultConfig(): void;
    getDefaultConfig(): PostgresqlConfig14 | undefined;
    setDefaultConfig(value?: PostgresqlConfig14): PostgresqlConfigSet14;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): PostgresqlConfigSet14.AsObject;
    static toObject(includeInstance: boolean, msg: PostgresqlConfigSet14): PostgresqlConfigSet14.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: PostgresqlConfigSet14, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): PostgresqlConfigSet14;
    static deserializeBinaryFromReader(message: PostgresqlConfigSet14, reader: jspb.BinaryReader): PostgresqlConfigSet14;
}

export namespace PostgresqlConfigSet14 {
    export type AsObject = {
        effectiveConfig?: PostgresqlConfig14.AsObject,
        userConfig?: PostgresqlConfig14.AsObject,
        defaultConfig?: PostgresqlConfig14.AsObject,
    }
}
