...
export class ListClustersResponse extends jspb.Message { 
    ...
    getClustersList(): Array<yandex_cloud_mdb_mysql_v1_cluster_pb.Cluster>;
    setClustersList(value: Array<yandex_cloud_mdb_mysql_v1_cluster_pb.Cluster>): ListClustersResponse;
    addClusters(value?: yandex_cloud_mdb_mysql_v1_cluster_pb.Cluster, index?: number): yandex_cloud_mdb_mysql_v1_cluster_pb.Cluster;
...
export namespace ListClustersResponse {
    export type AsObject = {
        clustersList: Array<yandex_cloud_mdb_mysql_v1_cluster_pb.Cluster.AsObject>,
...
export class CreateClusterRequest extends jspb.Message { 
    ...
    clearLabelsMap(): void;
    getEnvironment(): yandex_cloud_mdb_mysql_v1_cluster_pb.Cluster.Environment;
    setEnvironment(value: yandex_cloud_mdb_mysql_v1_cluster_pb.Cluster.Environment): CreateClusterRequest;
    ...
    getDatabaseSpecsList(): Array<yandex_cloud_mdb_mysql_v1_database_pb.DatabaseSpec>;
    setDatabaseSpecsList(value: Array<yandex_cloud_mdb_mysql_v1_database_pb.DatabaseSpec>): CreateClusterRequest;
    addDatabaseSpecs(value?: yandex_cloud_mdb_mysql_v1_database_pb.DatabaseSpec, index?: number): yandex_cloud_mdb_mysql_v1_database_pb.DatabaseSpec;
    clearUserSpecsList(): void;
    getUserSpecsList(): Array<yandex_cloud_mdb_mysql_v1_user_pb.UserSpec>;
    setUserSpecsList(value: Array<yandex_cloud_mdb_mysql_v1_user_pb.UserSpec>): CreateClusterRequest;
    addUserSpecs(value?: yandex_cloud_mdb_mysql_v1_user_pb.UserSpec, index?: number): yandex_cloud_mdb_mysql_v1_user_pb.UserSpec;
...
export namespace CreateClusterRequest {
    export type AsObject = {
        ...
        environment: yandex_cloud_mdb_mysql_v1_cluster_pb.Cluster.Environment,
        configSpec?: ConfigSpec.AsObject,
        databaseSpecsList: Array<yandex_cloud_mdb_mysql_v1_database_pb.DatabaseSpec.AsObject>,
        userSpecsList: Array<yandex_cloud_mdb_mysql_v1_user_pb.UserSpec.AsObject>,
...
export class UpdateClusterRequest extends jspb.Message { 
    ...
    setMaintenanceWindow(value?: yandex_cloud_mdb_mysql_v1_maintenance_pb.MaintenanceWindow): UpdateClusterRequest;
    clearSecurityGroupIdsList(): void;
    getSecurityGroupIdsList(): Array<string>;
...
export class RestoreClusterRequest extends jspb.Message { 
    ...
    clearLabelsMap(): void;
    getEnvironment(): yandex_cloud_mdb_mysql_v1_cluster_pb.Cluster.Environment;
    setEnvironment(value: yandex_cloud_mdb_mysql_v1_cluster_pb.Cluster.Environment): RestoreClusterRequest;
...
export class ListClusterBackupsResponse extends jspb.Message { 
    ...
    getBackupsList(): Array<yandex_cloud_mdb_mysql_v1_backup_pb.Backup>;
    setBackupsList(value: Array<yandex_cloud_mdb_mysql_v1_backup_pb.Backup>): ListClusterBackupsResponse;
    addBackups(value?: yandex_cloud_mdb_mysql_v1_backup_pb.Backup, index?: number): yandex_cloud_mdb_mysql_v1_backup_pb.Backup;
    getNextPageToken(): string;
...
export namespace ListClusterBackupsResponse {
    export type AsObject = {
        backupsList: Array<yandex_cloud_mdb_mysql_v1_backup_pb.Backup.AsObject>,
        nextPageToken: string,
    }
}
...
export class ListClusterHostsResponse extends jspb.Message { 
    clearHostsList(): void;
    getHostsList(): Array<yandex_cloud_mdb_mysql_v1_cluster_pb.Host>;
    setHostsList(value: Array<yandex_cloud_mdb_mysql_v1_cluster_pb.Host>): ListClusterHostsResponse;
    addHosts(value?: yandex_cloud_mdb_mysql_v1_cluster_pb.Host, index?: number): yandex_cloud_mdb_mysql_v1_cluster_pb.Host;
    getNextPageToken(): string;
...
export namespace ListClusterHostsResponse {
    export type AsObject = {
        hostsList: Array<yandex_cloud_mdb_mysql_v1_cluster_pb.Host.AsObject>,
        nextPageToken: string,
    }
}
...
export class ConfigSpec extends jspb.Message { 
    ...
    getMysqlConfig57(): yandex_cloud_mdb_mysql_v1_config_mysql5_7_pb.MysqlConfig5_7 | undefined;
    setMysqlConfig57(value?: yandex_cloud_mdb_mysql_v1_config_mysql5_7_pb.MysqlConfig5_7): ConfigSpec;

    hasMysqlConfig80(): boolean;
    clearMysqlConfig80(): void;
    getMysqlConfig80(): yandex_cloud_mdb_mysql_v1_config_mysql8_0_pb.MysqlConfig8_0 | undefined;
    setMysqlConfig80(value?: yandex_cloud_mdb_mysql_v1_config_mysql8_0_pb.MysqlConfig8_0): ConfigSpec;

    hasResources(): boolean;
    clearResources(): void;
    getResources(): yandex_cloud_mdb_mysql_v1_cluster_pb.Resources | undefined;
    setResources(value?: yandex_cloud_mdb_mysql_v1_cluster_pb.Resources): ConfigSpec;
    ...
    hasAccess(): boolean;
    clearAccess(): void;
    getAccess(): yandex_cloud_mdb_mysql_v1_cluster_pb.Access | undefined;
    setAccess(value?: yandex_cloud_mdb_mysql_v1_cluster_pb.Access): ConfigSpec;
...
export namespace ConfigSpec {
    export type AsObject = {
        version: string,
        mysqlConfig57?: yandex_cloud_mdb_mysql_v1_config_mysql5_7_pb.MysqlConfig5_7.AsObject,
        mysqlConfig80?: yandex_cloud_mdb_mysql_v1_config_mysql8_0_pb.MysqlConfig8_0.AsObject,
        resources?: yandex_cloud_mdb_mysql_v1_cluster_pb.Resources.AsObject,
        backupWindowStart?: google_type_timeofday_pb.TimeOfDay.AsObject,
        access?: yandex_cloud_mdb_mysql_v1_cluster_pb.Access.AsObject,
    }
