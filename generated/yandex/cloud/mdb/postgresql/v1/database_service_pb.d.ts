...
export class ListDatabasesResponse extends jspb.Message { 
    ...
    getDatabasesList(): Array<yandex_cloud_mdb_postgresql_v1_database_pb.Database>;
    setDatabasesList(value: Array<yandex_cloud_mdb_postgresql_v1_database_pb.Database>): ListDatabasesResponse;
    addDatabases(value?: yandex_cloud_mdb_postgresql_v1_database_pb.Database, index?: number): yandex_cloud_mdb_postgresql_v1_database_pb.Database;
...
export namespace ListDatabasesResponse {
    export type AsObject = {
        databasesList: Array<yandex_cloud_mdb_postgresql_v1_database_pb.Database.AsObject>,
...
export class CreateDatabaseRequest extends jspb.Message { 
    ...
    getDatabaseSpec(): yandex_cloud_mdb_postgresql_v1_database_pb.DatabaseSpec | undefined;
    setDatabaseSpec(value?: yandex_cloud_mdb_postgresql_v1_database_pb.DatabaseSpec): CreateDatabaseRequest;
...
export namespace CreateDatabaseRequest {
    export type AsObject = {
        clusterId: string,
        databaseSpec?: yandex_cloud_mdb_postgresql_v1_database_pb.DatabaseSpec.AsObject,
    }
}
...
export class UpdateDatabaseRequest extends jspb.Message { 
    getClusterId(): string;
    setClusterId(value: string): UpdateDatabaseRequest;
    getDatabaseName(): string;
    setDatabaseName(value: string): UpdateDatabaseRequest;
    ...
    getExtensionsList(): Array<yandex_cloud_mdb_postgresql_v1_database_pb.Extension>;
    setExtensionsList(value: Array<yandex_cloud_mdb_postgresql_v1_database_pb.Extension>): UpdateDatabaseRequest;
    addExtensions(value?: yandex_cloud_mdb_postgresql_v1_database_pb.Extension, index?: number): yandex_cloud_mdb_postgresql_v1_database_pb.Extension;
...
export namespace UpdateDatabaseRequest {
    export type AsObject = {
        ...
        extensionsList: Array<yandex_cloud_mdb_postgresql_v1_database_pb.Extension.AsObject>,
    }
}

export class UpdateDatabaseMetadata extends jspb.Message { 
    getClusterId(): string;
    setClusterId(value: string): UpdateDatabaseMetadata;
    getDatabaseName(): string;
