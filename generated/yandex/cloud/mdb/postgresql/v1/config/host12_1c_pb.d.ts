...
// file: yandex/cloud/mdb/postgresql/v1/config/host12_1c.proto
...
export class PostgresqlHostConfig12_1C extends jspb.Message { 
    ...
    setRecoveryMinApplyDelay(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;

    hasSharedBuffers(): boolean;
    clearSharedBuffers(): void;
    getSharedBuffers(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setSharedBuffers(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;

    hasTempBuffers(): boolean;
    clearTempBuffers(): void;
    getTempBuffers(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setTempBuffers(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;

    hasWorkMem(): boolean;
    clearWorkMem(): void;
    getWorkMem(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setWorkMem(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;

    hasTempFileLimit(): boolean;
    clearTempFileLimit(): void;
    getTempFileLimit(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setTempFileLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;
    ...
    setBackendFlushAfter(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;
    ...
    setOldSnapshotThreshold(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;
    ...
    setMaxStandbyStreamingDelay(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;
    getConstraintExclusion(): PostgresqlHostConfig12_1C.ConstraintExclusion;
    setConstraintExclusion(value: PostgresqlHostConfig12_1C.ConstraintExclusion): PostgresqlHostConfig12_1C;
    ...
    setCursorTupleFraction(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlHostConfig12_1C;
    ...
    setFromCollapseLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;
    ...
    setJoinCollapseLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;
    getForceParallelMode(): PostgresqlHostConfig12_1C.ForceParallelMode;
    setForceParallelMode(value: PostgresqlHostConfig12_1C.ForceParallelMode): PostgresqlHostConfig12_1C;
    getClientMinMessages(): PostgresqlHostConfig12_1C.LogLevel;
    setClientMinMessages(value: PostgresqlHostConfig12_1C.LogLevel): PostgresqlHostConfig12_1C;
    getLogMinMessages(): PostgresqlHostConfig12_1C.LogLevel;
    setLogMinMessages(value: PostgresqlHostConfig12_1C.LogLevel): PostgresqlHostConfig12_1C;
    getLogMinErrorStatement(): PostgresqlHostConfig12_1C.LogLevel;
    setLogMinErrorStatement(value: PostgresqlHostConfig12_1C.LogLevel): PostgresqlHostConfig12_1C;
    ...
    setLogMinDurationStatement(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;

    hasLogCheckpoints(): boolean;
    clearLogCheckpoints(): void;
    getLogCheckpoints(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogCheckpoints(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12_1C;

    hasLogConnections(): boolean;
    clearLogConnections(): void;
    getLogConnections(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogConnections(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12_1C;
    ...
    setLogDisconnections(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12_1C;

    hasLogDuration(): boolean;
    clearLogDuration(): void;
    getLogDuration(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogDuration(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12_1C;
    getLogErrorVerbosity(): PostgresqlHostConfig12_1C.LogErrorVerbosity;
    setLogErrorVerbosity(value: PostgresqlHostConfig12_1C.LogErrorVerbosity): PostgresqlHostConfig12_1C;

    hasLogLockWaits(): boolean;
    clearLogLockWaits(): void;
    getLogLockWaits(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogLockWaits(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12_1C;
    getLogStatement(): PostgresqlHostConfig12_1C.LogStatement;
    setLogStatement(value: PostgresqlHostConfig12_1C.LogStatement): PostgresqlHostConfig12_1C;

    hasLogTempFiles(): boolean;
    clearLogTempFiles(): void;
    getLogTempFiles(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setLogTempFiles(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;
    getSearchPath(): string;
    setSearchPath(value: string): PostgresqlHostConfig12_1C;

    hasRowSecurity(): boolean;
    clearRowSecurity(): void;
    getRowSecurity(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setRowSecurity(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12_1C;
    getDefaultTransactionIsolation(): PostgresqlHostConfig12_1C.TransactionIsolation;
    setDefaultTransactionIsolation(value: PostgresqlHostConfig12_1C.TransactionIsolation): PostgresqlHostConfig12_1C;
    ...
    setStatementTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;

    hasLockTimeout(): boolean;
    clearLockTimeout(): void;
    getLockTimeout(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setLockTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;
    ...
    setIdleInTransactionSessionTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;
    getByteaOutput(): PostgresqlHostConfig12_1C.ByteaOutput;
    setByteaOutput(value: PostgresqlHostConfig12_1C.ByteaOutput): PostgresqlHostConfig12_1C;
    getXmlbinary(): PostgresqlHostConfig12_1C.XmlBinary;
    setXmlbinary(value: PostgresqlHostConfig12_1C.XmlBinary): PostgresqlHostConfig12_1C;
    getXmloption(): PostgresqlHostConfig12_1C.XmlOption;
    setXmloption(value: PostgresqlHostConfig12_1C.XmlOption): PostgresqlHostConfig12_1C;
    ...
    setGinPendingListLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;

    hasDeadlockTimeout(): boolean;
    clearDeadlockTimeout(): void;
    getDeadlockTimeout(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setDeadlockTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;
    ...
    setMaxLocksPerTransaction(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;
    ...
    setMaxPredLocksPerTransaction(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;

    hasArrayNulls(): boolean;
    clearArrayNulls(): void;
    getArrayNulls(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setArrayNulls(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12_1C;
    getBackslashQuote(): PostgresqlHostConfig12_1C.BackslashQuote;
    setBackslashQuote(value: PostgresqlHostConfig12_1C.BackslashQuote): PostgresqlHostConfig12_1C;

    hasDefaultWithOids(): boolean;
    clearDefaultWithOids(): void;
    getDefaultWithOids(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setDefaultWithOids(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12_1C;
    ...
    setEscapeStringWarning(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12_1C;
    ...
    setLoCompatPrivileges(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12_1C;
    ...
    setOperatorPrecedenceWarning(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12_1C;
    ...
    setQuoteAllIdentifiers(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12_1C;
    ...
    setStandardConformingStrings(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12_1C;
    ...
    setSynchronizeSeqscans(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12_1C;
    ...
    setMaxParallelWorkers(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;
    ...
    setMaxParallelWorkersPerGather(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;
    getTimezone(): string;
    setTimezone(value: string): PostgresqlHostConfig12_1C;
    ...
    setEffectiveIoConcurrency(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;
    ...
    setEffectiveCacheSize(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12_1C;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): PostgresqlHostConfig12_1C.AsObject;
    static toObject(includeInstance: boolean, msg: PostgresqlHostConfig12_1C): PostgresqlHostConfig12_1C.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: PostgresqlHostConfig12_1C, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): PostgresqlHostConfig12_1C;
    static deserializeBinaryFromReader(message: PostgresqlHostConfig12_1C, reader: jspb.BinaryReader): PostgresqlHostConfig12_1C;
}

export namespace PostgresqlHostConfig12_1C {
    export type AsObject = {
        ...
        constraintExclusion: PostgresqlHostConfig12_1C.ConstraintExclusion,
        ...
        forceParallelMode: PostgresqlHostConfig12_1C.ForceParallelMode,
        clientMinMessages: PostgresqlHostConfig12_1C.LogLevel,
        logMinMessages: PostgresqlHostConfig12_1C.LogLevel,
        logMinErrorStatement: PostgresqlHostConfig12_1C.LogLevel,
        ...
        logErrorVerbosity: PostgresqlHostConfig12_1C.LogErrorVerbosity,
        logLockWaits?: google_protobuf_wrappers_pb.BoolValue.AsObject,
        logStatement: PostgresqlHostConfig12_1C.LogStatement,
        logTempFiles?: google_protobuf_wrappers_pb.Int64Value.AsObject,
        searchPath: string,
        rowSecurity?: google_protobuf_wrappers_pb.BoolValue.AsObject,
        defaultTransactionIsolation: PostgresqlHostConfig12_1C.TransactionIsolation,
        ...
        byteaOutput: PostgresqlHostConfig12_1C.ByteaOutput,
        xmlbinary: PostgresqlHostConfig12_1C.XmlBinary,
        xmloption: PostgresqlHostConfig12_1C.XmlOption,
        ...
        backslashQuote: PostgresqlHostConfig12_1C.BackslashQuote,
