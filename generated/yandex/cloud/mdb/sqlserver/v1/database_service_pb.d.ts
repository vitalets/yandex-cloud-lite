...
export class ListDatabasesResponse extends jspb.Message { 
    ...
    getDatabasesList(): Array<yandex_cloud_mdb_sqlserver_v1_database_pb.Database>;
    setDatabasesList(value: Array<yandex_cloud_mdb_sqlserver_v1_database_pb.Database>): ListDatabasesResponse;
    addDatabases(value?: yandex_cloud_mdb_sqlserver_v1_database_pb.Database, index?: number): yandex_cloud_mdb_sqlserver_v1_database_pb.Database;
...
export namespace ListDatabasesResponse {
    export type AsObject = {
        databasesList: Array<yandex_cloud_mdb_sqlserver_v1_database_pb.Database.AsObject>,
...
export class CreateDatabaseRequest extends jspb.Message { 
    ...
    getDatabaseSpec(): yandex_cloud_mdb_sqlserver_v1_database_pb.DatabaseSpec | undefined;
    setDatabaseSpec(value?: yandex_cloud_mdb_sqlserver_v1_database_pb.DatabaseSpec): CreateDatabaseRequest;
...
export namespace CreateDatabaseRequest {
    export type AsObject = {
        clusterId: string,
        databaseSpec?: yandex_cloud_mdb_sqlserver_v1_database_pb.DatabaseSpec.AsObject,
    }
}
...
export class RestoreDatabaseMetadata extends jspb.Message { 
    getClusterId(): string;
    setClusterId(value: string): RestoreDatabaseMetadata;
    getDatabaseName(): string;
    setDatabaseName(value: string): RestoreDatabaseMetadata;
    getFromDatabase(): string;
    setFromDatabase(value: string): RestoreDatabaseMetadata;
    getBackupId(): string;
    setBackupId(value: string): RestoreDatabaseMetadata;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): RestoreDatabaseMetadata.AsObject;
    static toObject(includeInstance: boolean, msg: RestoreDatabaseMetadata): RestoreDatabaseMetadata.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: RestoreDatabaseMetadata, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): RestoreDatabaseMetadata;
    static deserializeBinaryFromReader(message: RestoreDatabaseMetadata, reader: jspb.BinaryReader): RestoreDatabaseMetadata;
}

export namespace RestoreDatabaseMetadata {
    export type AsObject = {
        clusterId: string,
        databaseName: string,
        fromDatabase: string,
...
export class RestoreDatabaseRequest extends jspb.Message { 
    getClusterId(): string;
    setClusterId(value: string): RestoreDatabaseRequest;
    getDatabaseName(): string;
    setDatabaseName(value: string): RestoreDatabaseRequest;
    getFromDatabase(): string;
    setFromDatabase(value: string): RestoreDatabaseRequest;
    getBackupId(): string;
    setBackupId(value: string): RestoreDatabaseRequest;

    hasTime(): boolean;
    clearTime(): void;
    getTime(): google_protobuf_timestamp_pb.Timestamp | undefined;
    setTime(value?: google_protobuf_timestamp_pb.Timestamp): RestoreDatabaseRequest;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): RestoreDatabaseRequest.AsObject;
    static toObject(includeInstance: boolean, msg: RestoreDatabaseRequest): RestoreDatabaseRequest.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: RestoreDatabaseRequest, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): RestoreDatabaseRequest;
    static deserializeBinaryFromReader(message: RestoreDatabaseRequest, reader: jspb.BinaryReader): RestoreDatabaseRequest;
}
