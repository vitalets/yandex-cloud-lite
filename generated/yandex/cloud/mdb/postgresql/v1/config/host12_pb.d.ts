...
// file: yandex/cloud/mdb/postgresql/v1/config/host12.proto
...
export class PostgresqlHostConfig12 extends jspb.Message { 
    ...
    setRecoveryMinApplyDelay(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;

    hasSharedBuffers(): boolean;
    clearSharedBuffers(): void;
    getSharedBuffers(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setSharedBuffers(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;

    hasTempBuffers(): boolean;
    clearTempBuffers(): void;
    getTempBuffers(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setTempBuffers(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;

    hasWorkMem(): boolean;
    clearWorkMem(): void;
    getWorkMem(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setWorkMem(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;

    hasTempFileLimit(): boolean;
    clearTempFileLimit(): void;
    getTempFileLimit(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setTempFileLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;
    ...
    setBackendFlushAfter(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;
    ...
    setOldSnapshotThreshold(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;
    ...
    setMaxStandbyStreamingDelay(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;
    getConstraintExclusion(): PostgresqlHostConfig12.ConstraintExclusion;
    setConstraintExclusion(value: PostgresqlHostConfig12.ConstraintExclusion): PostgresqlHostConfig12;
    ...
    setCursorTupleFraction(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlHostConfig12;
    ...
    setFromCollapseLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;
    ...
    setJoinCollapseLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;
    getForceParallelMode(): PostgresqlHostConfig12.ForceParallelMode;
    setForceParallelMode(value: PostgresqlHostConfig12.ForceParallelMode): PostgresqlHostConfig12;
    getClientMinMessages(): PostgresqlHostConfig12.LogLevel;
    setClientMinMessages(value: PostgresqlHostConfig12.LogLevel): PostgresqlHostConfig12;
    getLogMinMessages(): PostgresqlHostConfig12.LogLevel;
    setLogMinMessages(value: PostgresqlHostConfig12.LogLevel): PostgresqlHostConfig12;
    getLogMinErrorStatement(): PostgresqlHostConfig12.LogLevel;
    setLogMinErrorStatement(value: PostgresqlHostConfig12.LogLevel): PostgresqlHostConfig12;
    ...
    setLogMinDurationStatement(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;

    hasLogCheckpoints(): boolean;
    clearLogCheckpoints(): void;
    getLogCheckpoints(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogCheckpoints(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12;

    hasLogConnections(): boolean;
    clearLogConnections(): void;
    getLogConnections(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogConnections(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12;
    ...
    setLogDisconnections(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12;

    hasLogDuration(): boolean;
    clearLogDuration(): void;
    getLogDuration(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogDuration(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12;
    getLogErrorVerbosity(): PostgresqlHostConfig12.LogErrorVerbosity;
    setLogErrorVerbosity(value: PostgresqlHostConfig12.LogErrorVerbosity): PostgresqlHostConfig12;

    hasLogLockWaits(): boolean;
    clearLogLockWaits(): void;
    getLogLockWaits(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogLockWaits(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12;
    getLogStatement(): PostgresqlHostConfig12.LogStatement;
    setLogStatement(value: PostgresqlHostConfig12.LogStatement): PostgresqlHostConfig12;

    hasLogTempFiles(): boolean;
    clearLogTempFiles(): void;
    getLogTempFiles(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setLogTempFiles(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;
    getSearchPath(): string;
    setSearchPath(value: string): PostgresqlHostConfig12;

    hasRowSecurity(): boolean;
    clearRowSecurity(): void;
    getRowSecurity(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setRowSecurity(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12;
    getDefaultTransactionIsolation(): PostgresqlHostConfig12.TransactionIsolation;
    setDefaultTransactionIsolation(value: PostgresqlHostConfig12.TransactionIsolation): PostgresqlHostConfig12;
    ...
    setStatementTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;

    hasLockTimeout(): boolean;
    clearLockTimeout(): void;
    getLockTimeout(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setLockTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;
    ...
    setIdleInTransactionSessionTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;
    getByteaOutput(): PostgresqlHostConfig12.ByteaOutput;
    setByteaOutput(value: PostgresqlHostConfig12.ByteaOutput): PostgresqlHostConfig12;
    getXmlbinary(): PostgresqlHostConfig12.XmlBinary;
    setXmlbinary(value: PostgresqlHostConfig12.XmlBinary): PostgresqlHostConfig12;
    getXmloption(): PostgresqlHostConfig12.XmlOption;
    setXmloption(value: PostgresqlHostConfig12.XmlOption): PostgresqlHostConfig12;
    ...
    setGinPendingListLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;

    hasDeadlockTimeout(): boolean;
    clearDeadlockTimeout(): void;
    getDeadlockTimeout(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setDeadlockTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;
    ...
    setMaxLocksPerTransaction(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;
    ...
    setMaxPredLocksPerTransaction(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;

    hasArrayNulls(): boolean;
    clearArrayNulls(): void;
    getArrayNulls(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setArrayNulls(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12;
    getBackslashQuote(): PostgresqlHostConfig12.BackslashQuote;
    setBackslashQuote(value: PostgresqlHostConfig12.BackslashQuote): PostgresqlHostConfig12;

    hasDefaultWithOids(): boolean;
    clearDefaultWithOids(): void;
    getDefaultWithOids(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setDefaultWithOids(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12;
    ...
    setEscapeStringWarning(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12;
    ...
    setLoCompatPrivileges(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12;
    ...
    setOperatorPrecedenceWarning(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12;
    ...
    setQuoteAllIdentifiers(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12;
    ...
    setStandardConformingStrings(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12;
    ...
    setSynchronizeSeqscans(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig12;
    ...
    setMaxParallelWorkers(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;
    ...
    setMaxParallelWorkersPerGather(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;
    getTimezone(): string;
    setTimezone(value: string): PostgresqlHostConfig12;
    ...
    setEffectiveIoConcurrency(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;
    ...
    setEffectiveCacheSize(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig12;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): PostgresqlHostConfig12.AsObject;
    static toObject(includeInstance: boolean, msg: PostgresqlHostConfig12): PostgresqlHostConfig12.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: PostgresqlHostConfig12, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): PostgresqlHostConfig12;
    static deserializeBinaryFromReader(message: PostgresqlHostConfig12, reader: jspb.BinaryReader): PostgresqlHostConfig12;
}

export namespace PostgresqlHostConfig12 {
    export type AsObject = {
        ...
        constraintExclusion: PostgresqlHostConfig12.ConstraintExclusion,
        ...
        forceParallelMode: PostgresqlHostConfig12.ForceParallelMode,
        clientMinMessages: PostgresqlHostConfig12.LogLevel,
        logMinMessages: PostgresqlHostConfig12.LogLevel,
        logMinErrorStatement: PostgresqlHostConfig12.LogLevel,
        ...
        logErrorVerbosity: PostgresqlHostConfig12.LogErrorVerbosity,
        logLockWaits?: google_protobuf_wrappers_pb.BoolValue.AsObject,
        logStatement: PostgresqlHostConfig12.LogStatement,
        logTempFiles?: google_protobuf_wrappers_pb.Int64Value.AsObject,
        searchPath: string,
        rowSecurity?: google_protobuf_wrappers_pb.BoolValue.AsObject,
        defaultTransactionIsolation: PostgresqlHostConfig12.TransactionIsolation,
        ...
        byteaOutput: PostgresqlHostConfig12.ByteaOutput,
        xmlbinary: PostgresqlHostConfig12.XmlBinary,
        xmloption: PostgresqlHostConfig12.XmlOption,
        ...
        backslashQuote: PostgresqlHostConfig12.BackslashQuote,
