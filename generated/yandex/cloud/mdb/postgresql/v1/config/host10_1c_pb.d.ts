...
// file: yandex/cloud/mdb/postgresql/v1/config/host10_1c.proto
...
export class PostgresqlHostConfig10_1C extends jspb.Message { 
    ...
    setRecoveryMinApplyDelay(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;

    hasSharedBuffers(): boolean;
    clearSharedBuffers(): void;
    getSharedBuffers(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setSharedBuffers(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;

    hasTempBuffers(): boolean;
    clearTempBuffers(): void;
    getTempBuffers(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setTempBuffers(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;

    hasWorkMem(): boolean;
    clearWorkMem(): void;
    getWorkMem(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setWorkMem(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;
    ...
    setReplacementSortTuples(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;

    hasTempFileLimit(): boolean;
    clearTempFileLimit(): void;
    getTempFileLimit(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setTempFileLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;
    ...
    setBackendFlushAfter(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;
    ...
    setOldSnapshotThreshold(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;
    ...
    setMaxStandbyStreamingDelay(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;
    getConstraintExclusion(): PostgresqlHostConfig10_1C.ConstraintExclusion;
    setConstraintExclusion(value: PostgresqlHostConfig10_1C.ConstraintExclusion): PostgresqlHostConfig10_1C;
    ...
    setCursorTupleFraction(value?: google_protobuf_wrappers_pb.DoubleValue): PostgresqlHostConfig10_1C;
    ...
    setFromCollapseLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;
    ...
    setJoinCollapseLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;
    getForceParallelMode(): PostgresqlHostConfig10_1C.ForceParallelMode;
    setForceParallelMode(value: PostgresqlHostConfig10_1C.ForceParallelMode): PostgresqlHostConfig10_1C;
    getClientMinMessages(): PostgresqlHostConfig10_1C.LogLevel;
    setClientMinMessages(value: PostgresqlHostConfig10_1C.LogLevel): PostgresqlHostConfig10_1C;
    getLogMinMessages(): PostgresqlHostConfig10_1C.LogLevel;
    setLogMinMessages(value: PostgresqlHostConfig10_1C.LogLevel): PostgresqlHostConfig10_1C;
    getLogMinErrorStatement(): PostgresqlHostConfig10_1C.LogLevel;
    setLogMinErrorStatement(value: PostgresqlHostConfig10_1C.LogLevel): PostgresqlHostConfig10_1C;
    ...
    setLogMinDurationStatement(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;

    hasLogCheckpoints(): boolean;
    clearLogCheckpoints(): void;
    getLogCheckpoints(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogCheckpoints(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig10_1C;

    hasLogConnections(): boolean;
    clearLogConnections(): void;
    getLogConnections(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogConnections(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig10_1C;
    ...
    setLogDisconnections(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig10_1C;

    hasLogDuration(): boolean;
    clearLogDuration(): void;
    getLogDuration(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogDuration(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig10_1C;
    getLogErrorVerbosity(): PostgresqlHostConfig10_1C.LogErrorVerbosity;
    setLogErrorVerbosity(value: PostgresqlHostConfig10_1C.LogErrorVerbosity): PostgresqlHostConfig10_1C;

    hasLogLockWaits(): boolean;
    clearLogLockWaits(): void;
    getLogLockWaits(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setLogLockWaits(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig10_1C;
    getLogStatement(): PostgresqlHostConfig10_1C.LogStatement;
    setLogStatement(value: PostgresqlHostConfig10_1C.LogStatement): PostgresqlHostConfig10_1C;

    hasLogTempFiles(): boolean;
    clearLogTempFiles(): void;
    getLogTempFiles(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setLogTempFiles(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;
    getSearchPath(): string;
    setSearchPath(value: string): PostgresqlHostConfig10_1C;

    hasRowSecurity(): boolean;
    clearRowSecurity(): void;
    getRowSecurity(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setRowSecurity(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig10_1C;
    getDefaultTransactionIsolation(): PostgresqlHostConfig10_1C.TransactionIsolation;
    setDefaultTransactionIsolation(value: PostgresqlHostConfig10_1C.TransactionIsolation): PostgresqlHostConfig10_1C;
    ...
    setStatementTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;

    hasLockTimeout(): boolean;
    clearLockTimeout(): void;
    getLockTimeout(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setLockTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;
    ...
    setIdleInTransactionSessionTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;
    getByteaOutput(): PostgresqlHostConfig10_1C.ByteaOutput;
    setByteaOutput(value: PostgresqlHostConfig10_1C.ByteaOutput): PostgresqlHostConfig10_1C;
    getXmlbinary(): PostgresqlHostConfig10_1C.XmlBinary;
    setXmlbinary(value: PostgresqlHostConfig10_1C.XmlBinary): PostgresqlHostConfig10_1C;
    getXmloption(): PostgresqlHostConfig10_1C.XmlOption;
    setXmloption(value: PostgresqlHostConfig10_1C.XmlOption): PostgresqlHostConfig10_1C;
    ...
    setGinPendingListLimit(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;

    hasDeadlockTimeout(): boolean;
    clearDeadlockTimeout(): void;
    getDeadlockTimeout(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setDeadlockTimeout(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;
    ...
    setMaxLocksPerTransaction(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;
    ...
    setMaxPredLocksPerTransaction(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;

    hasArrayNulls(): boolean;
    clearArrayNulls(): void;
    getArrayNulls(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setArrayNulls(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig10_1C;
    getBackslashQuote(): PostgresqlHostConfig10_1C.BackslashQuote;
    setBackslashQuote(value: PostgresqlHostConfig10_1C.BackslashQuote): PostgresqlHostConfig10_1C;

    hasDefaultWithOids(): boolean;
    clearDefaultWithOids(): void;
    getDefaultWithOids(): google_protobuf_wrappers_pb.BoolValue | undefined;
    setDefaultWithOids(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig10_1C;
    ...
    setEscapeStringWarning(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig10_1C;
    ...
    setLoCompatPrivileges(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig10_1C;
    ...
    setOperatorPrecedenceWarning(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig10_1C;
    ...
    setQuoteAllIdentifiers(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig10_1C;
    ...
    setStandardConformingStrings(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig10_1C;
    ...
    setSynchronizeSeqscans(value?: google_protobuf_wrappers_pb.BoolValue): PostgresqlHostConfig10_1C;
    ...
    setMaxParallelWorkers(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;
    ...
    setMaxParallelWorkersPerGather(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;
    getTimezone(): string;
    setTimezone(value: string): PostgresqlHostConfig10_1C;
    ...
    setEffectiveIoConcurrency(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;
    ...
    setEffectiveCacheSize(value?: google_protobuf_wrappers_pb.Int64Value): PostgresqlHostConfig10_1C;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): PostgresqlHostConfig10_1C.AsObject;
    static toObject(includeInstance: boolean, msg: PostgresqlHostConfig10_1C): PostgresqlHostConfig10_1C.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: PostgresqlHostConfig10_1C, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): PostgresqlHostConfig10_1C;
    static deserializeBinaryFromReader(message: PostgresqlHostConfig10_1C, reader: jspb.BinaryReader): PostgresqlHostConfig10_1C;
}

export namespace PostgresqlHostConfig10_1C {
    export type AsObject = {
        ...
        constraintExclusion: PostgresqlHostConfig10_1C.ConstraintExclusion,
        ...
        forceParallelMode: PostgresqlHostConfig10_1C.ForceParallelMode,
        clientMinMessages: PostgresqlHostConfig10_1C.LogLevel,
        logMinMessages: PostgresqlHostConfig10_1C.LogLevel,
        logMinErrorStatement: PostgresqlHostConfig10_1C.LogLevel,
        ...
        logErrorVerbosity: PostgresqlHostConfig10_1C.LogErrorVerbosity,
        logLockWaits?: google_protobuf_wrappers_pb.BoolValue.AsObject,
        logStatement: PostgresqlHostConfig10_1C.LogStatement,
        logTempFiles?: google_protobuf_wrappers_pb.Int64Value.AsObject,
        searchPath: string,
        rowSecurity?: google_protobuf_wrappers_pb.BoolValue.AsObject,
        defaultTransactionIsolation: PostgresqlHostConfig10_1C.TransactionIsolation,
        ...
        byteaOutput: PostgresqlHostConfig10_1C.ByteaOutput,
        xmlbinary: PostgresqlHostConfig10_1C.XmlBinary,
        xmloption: PostgresqlHostConfig10_1C.XmlOption,
        ...
        backslashQuote: PostgresqlHostConfig10_1C.BackslashQuote,
