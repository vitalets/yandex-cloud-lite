...
export class ListUsersResponse extends jspb.Message { 
    clearUsersList(): void;
    getUsersList(): Array<yandex_cloud_mdb_mysql_v1_user_pb.User>;
    setUsersList(value: Array<yandex_cloud_mdb_mysql_v1_user_pb.User>): ListUsersResponse;
    addUsers(value?: yandex_cloud_mdb_mysql_v1_user_pb.User, index?: number): yandex_cloud_mdb_mysql_v1_user_pb.User;
...
export namespace ListUsersResponse {
    export type AsObject = {
        usersList: Array<yandex_cloud_mdb_mysql_v1_user_pb.User.AsObject>,
...
export class CreateUserRequest extends jspb.Message { 
    ...
    hasUserSpec(): boolean;
    clearUserSpec(): void;
    getUserSpec(): yandex_cloud_mdb_mysql_v1_user_pb.UserSpec | undefined;
    setUserSpec(value?: yandex_cloud_mdb_mysql_v1_user_pb.UserSpec): CreateUserRequest;
...
export namespace CreateUserRequest {
    export type AsObject = {
        clusterId: string,
        userSpec?: yandex_cloud_mdb_mysql_v1_user_pb.UserSpec.AsObject,
    }
}
...
export class UpdateUserRequest extends jspb.Message { 
    ...
    getPermissionsList(): Array<yandex_cloud_mdb_mysql_v1_user_pb.Permission>;
    setPermissionsList(value: Array<yandex_cloud_mdb_mysql_v1_user_pb.Permission>): UpdateUserRequest;
    addPermissions(value?: yandex_cloud_mdb_mysql_v1_user_pb.Permission, index?: number): yandex_cloud_mdb_mysql_v1_user_pb.Permission;
    clearGlobalPermissionsList(): void;
    getGlobalPermissionsList(): Array<yandex_cloud_mdb_mysql_v1_user_pb.GlobalPermission>;
    setGlobalPermissionsList(value: Array<yandex_cloud_mdb_mysql_v1_user_pb.GlobalPermission>): UpdateUserRequest;
    addGlobalPermissions(value: yandex_cloud_mdb_mysql_v1_user_pb.GlobalPermission, index?: number): yandex_cloud_mdb_mysql_v1_user_pb.GlobalPermission;

    hasConnectionLimits(): boolean;
    clearConnectionLimits(): void;
    getConnectionLimits(): yandex_cloud_mdb_mysql_v1_user_pb.ConnectionLimits | undefined;
    setConnectionLimits(value?: yandex_cloud_mdb_mysql_v1_user_pb.ConnectionLimits): UpdateUserRequest;
    getAuthenticationPlugin(): yandex_cloud_mdb_mysql_v1_user_pb.AuthPlugin;
    setAuthenticationPlugin(value: yandex_cloud_mdb_mysql_v1_user_pb.AuthPlugin): UpdateUserRequest;
...
export namespace UpdateUserRequest {
    export type AsObject = {
        ...
        password: string,
        permissionsList: Array<yandex_cloud_mdb_mysql_v1_user_pb.Permission.AsObject>,
        globalPermissionsList: Array<yandex_cloud_mdb_mysql_v1_user_pb.GlobalPermission>,
        connectionLimits?: yandex_cloud_mdb_mysql_v1_user_pb.ConnectionLimits.AsObject,
        authenticationPlugin: yandex_cloud_mdb_mysql_v1_user_pb.AuthPlugin,
    }
}
...
export class GrantUserPermissionRequest extends jspb.Message { 
    ...
    getPermission(): yandex_cloud_mdb_mysql_v1_user_pb.Permission | undefined;
    setPermission(value?: yandex_cloud_mdb_mysql_v1_user_pb.Permission): GrantUserPermissionRequest;
...
export namespace GrantUserPermissionRequest {
    export type AsObject = {
        clusterId: string,
        userName: string,
        permission?: yandex_cloud_mdb_mysql_v1_user_pb.Permission.AsObject,
    }
}
...
export class RevokeUserPermissionRequest extends jspb.Message { 
    ...
    clearPermission(): void;
    getPermission(): yandex_cloud_mdb_mysql_v1_user_pb.Permission | undefined;
    setPermission(value?: yandex_cloud_mdb_mysql_v1_user_pb.Permission): RevokeUserPermissionRequest;
