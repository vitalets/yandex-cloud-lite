...
export class ListUsersResponse extends jspb.Message { 
    clearUsersList(): void;
    getUsersList(): Array<yandex_cloud_mdb_kafka_v1_user_pb.User>;
    setUsersList(value: Array<yandex_cloud_mdb_kafka_v1_user_pb.User>): ListUsersResponse;
    addUsers(value?: yandex_cloud_mdb_kafka_v1_user_pb.User, index?: number): yandex_cloud_mdb_kafka_v1_user_pb.User;
...
export namespace ListUsersResponse {
    export type AsObject = {
        usersList: Array<yandex_cloud_mdb_kafka_v1_user_pb.User.AsObject>,
...
export class CreateUserRequest extends jspb.Message { 
    ...
    hasUserSpec(): boolean;
    clearUserSpec(): void;
    getUserSpec(): yandex_cloud_mdb_kafka_v1_user_pb.UserSpec | undefined;
    setUserSpec(value?: yandex_cloud_mdb_kafka_v1_user_pb.UserSpec): CreateUserRequest;
...
export namespace CreateUserRequest {
    export type AsObject = {
        clusterId: string,
        userSpec?: yandex_cloud_mdb_kafka_v1_user_pb.UserSpec.AsObject,
    }
}
...
export class UpdateUserRequest extends jspb.Message { 
    ...
    getPermissionsList(): Array<yandex_cloud_mdb_kafka_v1_user_pb.Permission>;
    setPermissionsList(value: Array<yandex_cloud_mdb_kafka_v1_user_pb.Permission>): UpdateUserRequest;
    addPermissions(value?: yandex_cloud_mdb_kafka_v1_user_pb.Permission, index?: number): yandex_cloud_mdb_kafka_v1_user_pb.Permission;
...
export namespace UpdateUserRequest {
    export type AsObject = {
        ...
        password: string,
        permissionsList: Array<yandex_cloud_mdb_kafka_v1_user_pb.Permission.AsObject>,
    }
}
...
export class GrantUserPermissionRequest extends jspb.Message { 
    ...
    getPermission(): yandex_cloud_mdb_kafka_v1_user_pb.Permission | undefined;
    setPermission(value?: yandex_cloud_mdb_kafka_v1_user_pb.Permission): GrantUserPermissionRequest;
...
export namespace GrantUserPermissionRequest {
    export type AsObject = {
        clusterId: string,
        userName: string,
        permission?: yandex_cloud_mdb_kafka_v1_user_pb.Permission.AsObject,
    }
}
...
export class RevokeUserPermissionRequest extends jspb.Message { 
    ...
    clearPermission(): void;
    getPermission(): yandex_cloud_mdb_kafka_v1_user_pb.Permission | undefined;
    setPermission(value?: yandex_cloud_mdb_kafka_v1_user_pb.Permission): RevokeUserPermissionRequest;
