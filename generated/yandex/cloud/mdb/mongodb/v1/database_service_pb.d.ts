...
export class ListDatabasesResponse extends jspb.Message { 
    ...
    getDatabasesList(): Array<yandex_cloud_mdb_mongodb_v1_database_pb.Database>;
    setDatabasesList(value: Array<yandex_cloud_mdb_mongodb_v1_database_pb.Database>): ListDatabasesResponse;
    addDatabases(value?: yandex_cloud_mdb_mongodb_v1_database_pb.Database, index?: number): yandex_cloud_mdb_mongodb_v1_database_pb.Database;
...
export namespace ListDatabasesResponse {
    export type AsObject = {
        databasesList: Array<yandex_cloud_mdb_mongodb_v1_database_pb.Database.AsObject>,
...
export class CreateDatabaseRequest extends jspb.Message { 
    ...
    getDatabaseSpec(): yandex_cloud_mdb_mongodb_v1_database_pb.DatabaseSpec | undefined;
    setDatabaseSpec(value?: yandex_cloud_mdb_mongodb_v1_database_pb.DatabaseSpec): CreateDatabaseRequest;
...
export namespace CreateDatabaseRequest {
    export type AsObject = {
        clusterId: string,
        databaseSpec?: yandex_cloud_mdb_mongodb_v1_database_pb.DatabaseSpec.AsObject,
    }
}
