...
export class ListTargetGroupsResponse extends jspb.Message { 
    ...
    getTargetGroupsList(): Array<yandex_cloud_loadbalancer_v1_target_group_pb.TargetGroup>;
    setTargetGroupsList(value: Array<yandex_cloud_loadbalancer_v1_target_group_pb.TargetGroup>): ListTargetGroupsResponse;
    addTargetGroups(value?: yandex_cloud_loadbalancer_v1_target_group_pb.TargetGroup, index?: number): yandex_cloud_loadbalancer_v1_target_group_pb.TargetGroup;
...
export namespace ListTargetGroupsResponse {
    export type AsObject = {
        targetGroupsList: Array<yandex_cloud_loadbalancer_v1_target_group_pb.TargetGroup.AsObject>,
...
export class CreateTargetGroupRequest extends jspb.Message { 
    ...
    clearLabelsMap(): void;
    getRegionId(): string;
    setRegionId(value: string): CreateTargetGroupRequest;
    clearTargetsList(): void;
    getTargetsList(): Array<yandex_cloud_loadbalancer_v1_target_group_pb.Target>;
    setTargetsList(value: Array<yandex_cloud_loadbalancer_v1_target_group_pb.Target>): CreateTargetGroupRequest;
    addTargets(value?: yandex_cloud_loadbalancer_v1_target_group_pb.Target, index?: number): yandex_cloud_loadbalancer_v1_target_group_pb.Target;
...
export namespace CreateTargetGroupRequest {
    export type AsObject = {
        ...
        regionId: string,
        targetsList: Array<yandex_cloud_loadbalancer_v1_target_group_pb.Target.AsObject>,
    }
}
...
export class UpdateTargetGroupRequest extends jspb.Message { 
    ...
    clearTargetsList(): void;
    getTargetsList(): Array<yandex_cloud_loadbalancer_v1_target_group_pb.Target>;
    setTargetsList(value: Array<yandex_cloud_loadbalancer_v1_target_group_pb.Target>): UpdateTargetGroupRequest;
    addTargets(value?: yandex_cloud_loadbalancer_v1_target_group_pb.Target, index?: number): yandex_cloud_loadbalancer_v1_target_group_pb.Target;
...
export class AddTargetsRequest extends jspb.Message { 
    ...
    clearTargetsList(): void;
    getTargetsList(): Array<yandex_cloud_loadbalancer_v1_target_group_pb.Target>;
    setTargetsList(value: Array<yandex_cloud_loadbalancer_v1_target_group_pb.Target>): AddTargetsRequest;
    addTargets(value?: yandex_cloud_loadbalancer_v1_target_group_pb.Target, index?: number): yandex_cloud_loadbalancer_v1_target_group_pb.Target;
...
export class RemoveTargetsRequest extends jspb.Message { 
    ...
    clearTargetsList(): void;
    getTargetsList(): Array<yandex_cloud_loadbalancer_v1_target_group_pb.Target>;
    setTargetsList(value: Array<yandex_cloud_loadbalancer_v1_target_group_pb.Target>): RemoveTargetsRequest;
    addTargets(value?: yandex_cloud_loadbalancer_v1_target_group_pb.Target, index?: number): yandex_cloud_loadbalancer_v1_target_group_pb.Target;
